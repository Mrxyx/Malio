...
<div class="card">
<div class="card-body">
<h8><i class="fas fa-chart-pie"></i>今天签到了吗？</h8>
 {if $user->isAbleToCheckin() }
                ...
                {/if}
<h3 class="animated tada mt-5 text-center" style="color:#191d21">欢迎来到 XXX</h3>
<h5 class="mb-5 mt-2 text-center" style="color:#191d21d5">按照下面步骤开始使用吧!</h5>
<div class="row mt-4">
<div class="col-12 col-lg-8 offset-lg-2">
<div class="wizard-steps">
<div class="wizard-step wizard-step-active wizard-step-danger" onclick="location='/user/shop'">
